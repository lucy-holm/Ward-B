...
export class World {
  ...
  // `levels`, see loadRoom). This subsumes the older single-valued
  // heightZones/ramps model: a flat room's zones/ramps fold into the
  // '__flat' level. Public like colliders: main.ts reads `stairwells`
  // directly for its per-frame resolveLevel call.
